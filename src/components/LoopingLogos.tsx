...
class LoopingLogos extends React.Component<Props & IntersectionObserverProps> {
  private logos = [
    ...
    <img src="/university-logos/cedarville-logo-new-2.png" alt="Cedarville" key="cedarville" />,
    ...
    <img src="/university-logos/NULogo_stacked_WHITE.png" alt="National University" key="nu" />,
    ...
    <img src="/university-logos/2logo.png" alt="Logo 2" key="logo2" />
  ];
